...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "getFlattenedTree", function() { return __WEBPACK_IMPORTED_MODULE_3__getFlattenedTree__["a"]; });
...
var NODE_CHANGE_OPERATIONS = {
  CHANGE_NODE: function CHANGE_NODE(nodes, updatedNode) {
    return nodes.map(function (n) {
      return n.id === updatedNode.id ? __WEBPACK_IMPORTED_MODULE_1_lodash_omit___default()(updatedNode, FLATTEN_TREE_PROPERTIES) : n;
    });
  },
...
var Tree = function (_React$Component) {
  ...
  function Tree() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this._cache = new __WEBPACK_IMPORTED_MODULE_2_react_virtualized__["CellMeasurerCache"]({
      fixedWidth: true,
      minHeight: 20
...
Tree.propTypes = {
  nodes: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape(__WEBPACK_IMPORTED_MODULE_3__shapes_nodeShapes__["a" /* FlattenedNode */])).isRequired,
...
var Deletable = function Deletable(_ref) {
  ...
  var _getNodeRenderOptions = Object(__WEBPACK_IMPORTED_MODULE_4__selectors_nodes__["getNodeRenderOptions"])(node),
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'span',
    null,
    isDeletable && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { tabIndex: 0, onKeyDown: Object(__WEBPACK_IMPORTED_MODULE_3__eventWrappers__["a" /* submitEvent */])(handleChange), onClick: handleChange, className: className }),
    children
  );
};
...
var Expandable = function Expandable(_ref) {
  ...
  var handleChange = function handleChange() {
    return onChange(Object(__WEBPACK_IMPORTED_MODULE_4__selectors_nodes__["updateNode"])(node, { expanded: !isExpanded }));
  };

  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'span',
    { onDoubleClick: handleChange },
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { tabIndex: 0, onKeyDown: Object(__WEBPACK_IMPORTED_MODULE_3__eventWrappers__["a" /* submitEvent */])(handleChange), onClick: handleChange, className: className }),
    children
  );
};
...
var Favorite = function Favorite(_ref) {
  ...
  var handleChange = function handleChange() {
    return onChange(Object(__WEBPACK_IMPORTED_MODULE_4__selectors_nodes__["updateNode"])(node, { favorite: !isFavorite }));
  };
...
var FilteringContainer = (_temp = _class = function (_React$Component) {
  ...
  FilteringContainer.prototype.render = function render() {
    ...
    var _ref2 = filterTerm ? Object(__WEBPACK_IMPORTED_MODULE_6__selectors_filtering__["a" /* filterNodes */])(nameMatchesSearchTerm(filterTerm), relevantNodes.nodes) : relevantNodes,
  ...
  unfilteredNodes: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape(__WEBPACK_IMPORTED_MODULE_5__shapes_nodeShapes__["b" /* Node */])).isRequired
}, _class.defaultProps = {
